...
// logError is a generic for logging an error message.
...
// unexpected problem at runtime. It logs the detailed error message, then use the
...
func (app *application) notFoundResponse(w http.ResponseWriter, r *http.Request) {
	message := "the requested resourced could not be found"
	app.errorResponse(w, r, http.StatusNotFound, message)
}

// methodNotAllowedResponse will be used to send a 405 Method Not Allowed status code and
// JSON response to the client.
